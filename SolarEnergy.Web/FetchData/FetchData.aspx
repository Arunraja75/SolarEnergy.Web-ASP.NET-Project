<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FetchData.aspx.cs" Inherits="SolarEnergy.Web.Dashboard" %>
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-dark navbar-dark py-1 py-lg-0 px-lg-5">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            ...
            <div class="navbar-nav mr-auto py-0">
                <a href="#contact" class="nav-item nav-link">FetchData</a>
            </div>
    ...
    <div class="container-fluid py-5" id="contact" >
        <div class="container py-5">
            <div class="section-title position-relative text-center"> 
                <asp:Label ID="UserLabel" class="font-secondary display-4" runat="server" Text="Welcome "></asp:Label>                
            </div>
            <div>
               <form name="sentMessage"  novalidate="novalidate"  method="post" runat="server">
               <div class="form-col">
                    <div>
                         <asp:GridView ID="grd_FetchData" class=" px-4  bg-warning text-dark mx-auto text-center" style="width: 500px;" runat="server" method ="post" ></asp:GridView>
                     </div>
                     <div class="text-center">
                         <asp:Button ID="Button1" class="btn btn-primary font-weight-bold py-3 px-5"  runat="server" Text="FetchData" OnClick="txt_FetchData_Button_Click"  />                              
                      </div>
                </div>
               </form>
              </div>
