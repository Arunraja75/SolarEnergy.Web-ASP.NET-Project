<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="SolarEnergy.Web.login" %>
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-dark navbar-dark py-1 py-lg-0 px-lg-5">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            ...
            <div class="navbar-nav mr-auto py-0">
                <a href="#contact" class="nav-item nav-link">Login</a>
            </div>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item position-relative active" style="height: 100vh; min-height: 400px;">
                    <img class="position-absolute w-100 h-100" src="img/carousel-1.jpg" style="object-fit: cover; top: 0px; left: 0px;">
    ...
    <div class="container-fluid py-5" id="contact" >
        <div class="container py-5">
            <div class="section-title position-relative text-center">
                ...
                <h1 class="font-secondary display-4">Login</h1>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="contact-form">
                        <div id="success"></div>
                        <form name="sentMessage"  novalidate="novalidate" action="login.aspx" method="post" runat="server">
                            <div class="form-col">
                                <div class="col-sm-14 control-group">
                                    <asp:TextBox class="form-control bg-secondary border-0 py-4 px-3" ID="txt_login_Name" placeholder="Your Name" required="required" data-validation-required-message="Please enter your name" runat="server" ></asp:TextBox>                 
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="col-sm-14 control-group">
                                    <asp:TextBox type ="email" ID="txt_login_email" class="form-control bg-secondary border-0 py-4 px-3" placeholder="Your Email" required="required" data-validation-required-message="Please enter your email" runat="server"></asp:TextBox>                                   
                                    <p class="help-block text-danger"></p>
                                </div>
                                 <div class="col-sm-14 control-group">
                                    <asp:TextBox type ="password" ID="txt_login_Password" class="form-control bg-secondary border-0 py-4 px-3" placeholder="Your Password" required="required" data-validation-required-message="Please enter your Password" aria-describedby="passwordHelpBlock" runat="server"></asp:TextBox>                                   
                                    <p class="help-block text-danger"></p>
                                     
                               
                                <div class="text-center">
                                <asp:Button ID="txt_login_Button" class="btn btn-primary font-weight-bold py-3 px-5"  runat="server" Text="Login" OnClick="txt_login_Button_Click"  />                              
                                 </div>
                                     <br /> <br />
                                <div class="text-center">
                                    
                                    <asp:LinkButton ID="link_register" class="btn btn-primary font-weight-bold py-3 px-5 " runat="server" OnClick="link_register_Click" >Click Here for New Registration</asp:LinkButton>
                                    </div>
                           </div>
